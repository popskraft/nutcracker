...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('.gallery.style2', { style: 'pop-in', speed: 1000, intensity: 5, threshold: 1, delay: 0, stagger: 125, staggerSelector: ':scope ul > li', replay: false });
		...
		onvisible.add('.list.style2', { style: 'fade-up', speed: 750, intensity: 5, threshold: 2, delay: 0, stagger: 250, staggerSelector: ':scope ul > li, :scope ol > li', replay: false });
		...
		onvisible.add('#buttons02', { style: 'flip-right', speed: 750, intensity: 5, threshold: 1, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
