...
(function() {
	...
	// Video.
		class VideoThumbnail {
			 ...
			 * @var {string}
			 */
			static selector = 'div.video-component > .frame > .player.thumbnail';
		
			/**
			 * Active selector.
			 * @var {string}
			 */
			static activeSelector = 'div.video-component.is-active';
			...
			static {
				...
				// Bind "stopComponents" custom event.
					$body.addEventListener('stopComponents', (event) => {
		
						// No "parent" property in details? Bail.
							if (!('parent' in event.detail))
								return;
		
						// Get actively playing videos within parent.
							let a = event.detail.parent.querySelectorAll(this.activeSelector);
		
						// Step through videos.
							for (const e of a) {
		
								// Trigger "stopComponent" custom event.
									e.dispatchEvent(new CustomEvent('stopComponent'));
			...
			constructor(id, tag, attributes) {
				...
				// Bind "stopComponent" custom event.
					this.$element.addEventListener('stopComponent', (event) => {
			...
			/**
			 * Stops the video associated with this video thumbnail.
			 */
			stop() {
		
				// No video, or video isn't active? Bail.
					if (this.$video === null
					||	!this.$element.classList.contains('is-active'))
						return;
		
				// Remove "is-active" class from element.
					this.$element.classList.remove('is-active');
		
				// Add overlay to frame.
					this.$frame.classList.add('with-overlay');
		
				// Add thumbnail to frame.
					this.$frame.appendChild(this.$thumbnail);
		
				// Remove video from frame.
					this.$frame.removeChild(this.$video);
	...
	// Initialize "On Visible" animations.
		onvisible.add('.text-component.style-5', { style: 'fade-up', speed: 750, intensity: 5, threshold: 1, delay: 0, replay: false });
		onvisible.add('.text-component.style-3', { style: 'fade-up', speed: 750, intensity: 5, threshold: 1, delay: 125, replay: false });
		onvisible.add('.divider-component.style-1', { style: 'fade-right', speed: 625, intensity: 10, threshold: 1, delay: 0, replay: false });
		...
		onvisible.add('.text-component.style-18', { style: 'fade-up', speed: 750, intensity: 5, threshold: 1, delay: 0, replay: false });
		onvisible.add('.image-component.style-4', { style: 'pop-in', speed: 500, intensity: 3, threshold: 1, delay: 0, replay: false });
		onvisible.add('.gallery-component.style-2', { style: 'pop-in', speed: 1000, intensity: 5, threshold: 1, delay: 0, stagger: 125, staggerSelector: ':scope ul > li', replay: false });
		onvisible.add('.buttons-component.style-5', { style: 'flip-right', speed: 1000, intensity: 5, threshold: 1, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.text-component.style-7', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 1, delay: 500, replay: false });
		onvisible.add('.image-component.instance-2', { style: 'pop-in', speed: 750, intensity: 10, threshold: 2, delay: 500, replay: false });
		onvisible.add('.container-component.instance-3', { style: 'fade-in', speed: 250, intensity: 5, threshold: 1, delay: 0, replay: false });
		onvisible.add('.text-component.style-1', { style: 'zoom-in', speed: 750, intensity: 9, threshold: 1, delay: 0, replay: false });
		onvisible.add('.container-component.style-4', { style: 'pop-in', speed: 375, intensity: 5, threshold: 1, delay: 0, replay: false });
		onvisible.add('.image-component.style-2', { style: 'pop-in', speed: 500, intensity: 3, threshold: 1, delay: 0, replay: false });
		onvisible.add('.image-component.instance-16', { style: 'pop-in', speed: 750, intensity: 10, threshold: 2, delay: 500, replay: false });
		onvisible.add('.text-component.style-11', { style: 'fade-up', speed: 750, intensity: 5, threshold: 1, delay: 0, replay: false });
		onvisible.add('.text-component.style-16', { style: 'fade-up', speed: 750, intensity: 5, threshold: 1, delay: 0, replay: false });
		onvisible.add('.buttons-component.style-2', { style: 'flip-right', speed: 1000, intensity: 5, threshold: 1, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.list-component.style-2', { style: 'fade-up', speed: 750, intensity: 5, threshold: 2, delay: 0, stagger: 250, staggerSelector: ':scope > ul > li, :scope > ol > li', replay: false });
		onvisible.add('.text-component.style-15', { style: 'fade-up', speed: 750, intensity: 5, threshold: 1, delay: 0, replay: false });
		onvisible.add('.text-component.style-14', { style: 'fade-up', speed: 750, intensity: 5, threshold: 1, delay: 125, replay: false });
		onvisible.add('.image-component.style-3', { style: 'zoom-in', speed: 750, intensity: 9, threshold: 1, delay: 0, replay: false });
		onvisible.add('.buttons-component.style-7', { style: 'flip-right', speed: 1000, intensity: 5, threshold: 1, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.text-component.instance-52', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 1, delay: 0, replay: false });
		onvisible.add('.divider-component.style-9', { style: 'fade-right', speed: 625, intensity: 10, threshold: 1, delay: 0, replay: false });
		onvisible.add('.gallery-component.style-4', { style: 'pop-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope ul > li', replay: false });
		onvisible.add('.gallery-component.style-5', { style: 'pop-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope ul > li', replay: false });
		onvisible.add('.image-component.instance-4', { style: 'zoom-in', speed: 750, intensity: 9, threshold: 1, delay: 0, replay: false });
		onvisible.add('.text-component.style-13', { style: 'fade-up', speed: 750, intensity: 5, threshold: 1, delay: 0, replay: false });
		onvisible.add('.text-component.style-9', { style: 'fade-up', speed: 750, intensity: 5, threshold: 1, delay: 0, replay: false });
		...
		onvisible.add('.buttons-component.style-3', { style: 'flip-right', speed: 750, intensity: 5, threshold: 1, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.buttons-component.instance-2', { style: 'flip-right', speed: 750, intensity: 5, threshold: 1, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
